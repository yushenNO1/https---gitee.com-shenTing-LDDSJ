...
static CGFloat circleDuriation = 1.0f;
...
+(XLPaymentSuccessHUD*)showIn:(UIView*)view
                        frame:(CGRect)frame {
    [self hideIn:view];
    XLPaymentSuccessHUD *hud = [[XLPaymentSuccessHUD alloc] initWithFrame:frame];
    [hud start];
    [view addSubview:hud];
    return hud;
}
...
-(void)buildUI{
    ...
    _animationLayer.bounds = CGRectMake(0, 0, 90, 90);
...
-(void)circleAnimation{
    ...
    circleLayer.strokeColor  = [UIColor colorWithRed:250 / 255.0 green:47 / 255.0 blue:91 / 255.0 alpha:1].CGColor;
...
-(void)checkAnimation{
    ...
    checkLayer.strokeColor = [UIColor colorWithRed:250 / 255.0 green:47 / 255.0 blue:91 / 255.0 alpha:1].CGColor;
