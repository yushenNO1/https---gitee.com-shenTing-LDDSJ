...
@implementation LYTManagementCell
...
-(UIButton *)shareBtn
{
    if (!_shareBtn)
    {
        ...
        [_shareBtn setBackgroundImage:[UIImage imageNamed:@"Share_-goods@3x"] forState:UIControlStateNormal];
    }
    return _shareBtn;
}
...
-(UIButton *)downBtn
{
    if (!_downBtn)
    {
        ...
        [_downBtn setTitle:@"下线" forState:UIControlStateNormal];
